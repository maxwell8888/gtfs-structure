...
#[derive(Derivative, Debug, Copy, Clone, PartialEq, Eq, DeepSizeOf)]
...
#[derive(Debug, Derivative, Copy, Clone, PartialEq, Eq, Hash, DeepSizeOf)]
#[derivative(Default(bound = ""))]
pub enum RouteType {
...
#[derive(Debug, Derivative, Copy, Clone, PartialEq, Eq, DeepSizeOf)]
#[derivative(Default(bound = ""))]
...
#[derive(Debug, Derivative, Copy, Clone, PartialEq, DeepSizeOf)]
#[derivative(Default(bound = ""))]
...
#[derive(Debug, Derivative, Serialize, Copy, Clone, PartialEq, Eq, DeepSizeOf)]
#[derivative(Default)]
...
#[derive(Debug, Derivative, PartialEq, Eq, Hash, Clone, Copy, DeepSizeOf)]
#[derivative(Default)]
...
#[derive(Debug, Deserialize, Serialize, Copy, Clone, PartialEq, Eq, DeepSizeOf)]
...
#[derive(Debug, Serialize, Deserialize, Derivative, Copy, Clone, PartialEq, DeepSizeOf)]
#[derivative(Default)]
